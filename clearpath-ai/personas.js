...
export const PERSONAS = {
  ...
  'us-001': {
    ...
    suggestedActions: [
      { label: 'Quick Refill — $15', action: 'quick_refill' },
      { label: 'Change my plan', action: 'plan_change' },
      { label: 'I\'m fine for now', action: 'dismiss' },
    ],
  ...
  'us-002': {
    ...
    suggestedActions: [
      { label: 'Renew Total Base 5G — $40', action: 'renew_current' },
      { label: 'Upgrade to Unlimited — $55', action: 'upgrade_unlimited' },
      { label: 'Enable AutoPay & save $5', action: 'enable_autopay' },
    ],
  ...
  'us-003': {
    ...
    suggestedActions: [
      { label: 'Quick Refill — $15 data add-on', action: 'quick_refill' },
      { label: 'Redeem 1,000 pts for free 5 GB', action: 'redeem_points' },
      { label: 'Renew full plan early — $40', action: 'renew_early' },
    ],
  ...
  'us-004': {
    ...
    suggestedActions: [
      { label: 'Activate eSIM on iPhone 15 Pro', action: 'activate_esim' },
      { label: 'Scan physical SIM instead', action: 'scan_sim' },
      { label: 'Port my number from another carrier', action: 'port_in' },
    ],
  ...
  'us-005': {
    ...
    suggestedActions: [
      { label: 'Check for outages in my area', action: 'check_outage' },
      { label: 'Walk me through a fix', action: 'self_fix' },
      { label: 'Talk to someone', action: 'escalate_support' },
    ],
  ...
  'us-006': {
    ...
    suggestedActions: [
      { label: 'Upgrade to Unlimited — $55/mo', action: 'upgrade_unlimited' },
      { label: 'Start at next renewal (no charge today)', action: 'upgrade_at_renewal' },
      { label: 'Just add 5 GB for now — $10', action: 'data_addon' },
    ],
  ...
  'us-007': {
    ...
    suggestedActions: [
      { label: 'Add Global Calling Card — $10/mo', action: 'add_calling_card' },
      { label: 'Redeem 1,000 pts — get it free', action: 'redeem_calling_card' },
      { label: 'See all add-ons', action: 'browse_addons' },
    ],
  ...
  'us-008': {
    ...
    suggestedActions: [
      { label: 'See side-by-side plan comparison', action: 'compare_plans' },
      { label: 'Calculate 4-line family pricing', action: 'family_pricing' },
      { label: 'Upgrade to Unlimited', action: 'upgrade_unlimited' },
    ],
